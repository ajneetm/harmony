export const translations = {
  ...
  ar: {
    ...
    hero: {
      ...
      aboutPlatformContent: 'تجمع هارموني بين التصفح المباشر، والاستبيانات الذكية، وإمكانية إنشاء استبيان خاص بالمشكلة، مع توظيف الذكاء الاصطناعي لتعزيز التحليل، والالتزام التام بخصوصية المعلومات وسريتها.',
      whyChooseUs: 'لماذا تختارنا؟',
      whyChooseUsContent: 'لأن هارموني لا يقدم حلولًا تحفيزية عابرة، بل يوفّر نظامًا متكاملًا لفهم الذات، وقياس التجانس الداخلي، وتوجيه السلوك بمنهجية دقيقة، وخصوصية عالية، وموثوقية مهنية راسخة.',
      ourServices: 'ما هي خدماتنا؟',
      ourServicesContent: 'نقدّم استبيانات مباشرة ومخصصة، واستشارات معتمدة، وورشًا تطبيقية متقدمة، مدعومة ببرامج وفعاليات ترتبط باعتمادات مهنية دولية من CPD، بما يعزز القيمة التدريبية والموثوقية المهنية.',
