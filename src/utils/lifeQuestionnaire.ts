...
export const LIFE_QUESTIONNAIRE_AR = {
  category: "في الحياة",
  questions: [
    { id: 1,  reversed: false, dimension: "البعد السلوكي",  element: "الاستقبال", type: "شعوري",  text: "أشعر بالطمأنينة حتى عند مواجهة أحداث غير متوقعة." },
    { id: 2,  reversed: false, dimension: "البعد النفسي",   element: "الجاهزية",  type: "معرفي",  text: "أعرف ما أحتاجه لأكون مستعدًا للتغيير." },
    { id: 3,  reversed: true,  dimension: "البعد الفيزيائي",element: "التفاعل",   type: "سلوكي",  text: "أجد صعوبة في التكيف مع المواقف الصعبة." },
    { id: 4,  reversed: false, dimension: "البعد السلوكي",  element: "التطور",    type: "معرفي",  text: "أستفيد من تجاربي اليومية في تطوير نفسي." },
    { id: 5,  reversed: true,  dimension: "البعد النفسي",   element: "الإدراك",   type: "سلوكي",  text: "لا أحول معرفتي بمشكلاتي إلى خطوات عملية." },
    { id: 6,  reversed: false, dimension: "البعد الفيزيائي",element: "الفعل",     type: "شعوري",  text: "أشعر بالرضا عن جهودي اليومية لتحقيق أهدافي." },
    { id: 7,  reversed: true,  dimension: "البعد السلوكي",  element: "الأثر",     type: "سلوكي",  text: "لا أطور سلوكي بما يعكس أفضل ما لدي." },
    { id: 8,  reversed: false, dimension: "البعد النفسي",   element: "النية",     type: "شعوري",  text: "أشعر بالصدق والإخلاص تجاه أهدافي المستقبلية." },
    { id: 9,  reversed: false, dimension: "البعد الفيزيائي",element: "الاستجابة", type: "معرفي",  text: "أتعلم من نتائج أفعالي." },
    { id: 10, reversed: false, dimension: "البعد السلوكي",  element: "الاستقبال", type: "معرفي",  text: "أفهم كيف أفسر الأحداث التي أمر بها." },
    { id: 11, reversed: false, dimension: "البعد النفسي",   element: "الجاهزية",  type: "سلوكي",  text: "أهيئ نفسي لاتخاذ قرارات تحسن حياتي." },
    { id: 12, reversed: true,  dimension: "البعد الفيزيائي",element: "التفاعل",   type: "معرفي",  text: "أجد صعوبة في إدراك أثر قراراتي على الآخرين." },
    { id: 13, reversed: false, dimension: "البعد السلوكي",  element: "الأثر",     type: "شعوري",  text: "أشعر بالرضا عن الصورة التي أكونها عن نفسي." },
    { id: 14, reversed: true,  dimension: "البعد النفسي",   element: "الإدراك",   type: "معرفي",  text: "لا أعرف بوضوح ما أحتاج إلى تطويره في حياتي." },
    { id: 15, reversed: false, dimension: "البعد الفيزيائي",element: "الفعل",     type: "سلوكي",  text: "أتحرك بخطوات منتظمة نحو حياة أفضل." },
    { id: 16, reversed: true,  dimension: "البعد السلوكي",  element: "التطور",    type: "سلوكي",  text: "لا أستفيد من خبراتي السابقة في تطوير سلوكي." },
    { id: 17, reversed: false, dimension: "البعد النفسي",   element: "النية",     type: "معرفي",  text: "أحدد بوعي ما أريد أن أحققه في حياتي." },
    { id: 18, reversed: false, dimension: "البعد الفيزيائي",element: "الاستجابة", type: "شعوري",  text: "أشعر بالفخر عندما أرى أثر جهودي في حياتي." },
    { id: 19, reversed: false, dimension: "البعد السلوكي",  element: "الاستقبال", type: "سلوكي",  text: "أتعامل مع المواقف المختلفة بوعي وحكمة." },
    { id: 20, reversed: false, dimension: "البعد النفسي",   element: "الجاهزية",  type: "شعوري",  text: "أشعر بالحماس لبدء خطوات التغيير." },
    { id: 21, reversed: true,  dimension: "البعد الفيزيائي",element: "التفاعل",   type: "شعوري",  text: "أجد صعوبة في بناء علاقات إيجابية مع الآخرين." },
    { id: 22, reversed: false, dimension: "البعد السلوكي",  element: "الأثر",     type: "معرفي",  text: "لدي صورة واضحة عن الحياة التي أطمح إليها." },
    { id: 23, reversed: true,  dimension: "البعد النفسي",   element: "الإدراك",   type: "شعوري",  text: "لا ألاحظ تراجعي النفسي إلا بعد أن يؤثر في حياتي." },
    { id: 24, reversed: false, dimension: "البعد الفيزيائي",element: "الفعل",     type: "معرفي",  text: "أعرف الخطوة التالية التي تقربني من أهدافي." },
    { id: 25, reversed: false, dimension: "البعد السلوكي",  element: "التطور",    type: "شعوري",  text: "أشعر بالفخر عندما ألاحظ تطوري مع مرور الوقت." },
    { id: 26, reversed: true,  dimension: "البعد النفسي",   element: "النية",     type: "سلوكي",  text: "أجد صعوبة في تحويل نواياي إلى أفعال." },
    { id: 27, reversed: false, dimension: "البعد الفيزيائي",element: "الاستجابة", type: "سلوكي",  text: "أغير أسلوبي عندما أكتشف أنه لا يقودني إلى النتائج التي أريدها." }
  ]
};
